...
function instrumented(target, key, descriptor) {
    ...
    function overrideMethod() {
        var _this = this;
        var args = arguments;
        return instrument(klass + "." + key, function () { return __awaiter(_this, void 0, void 0, function () {
...
function instrument(name, delegate) {
    return __awaiter(this, void 0, void 0, function () {
        var t, errors, start, err_1, elapsed, elapsedNanos;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    t = timer(name);
                ...
                case 4:
                    ...
                    elapsedNanos = (elapsed[0] * 1000000000) + elapsed[1];
